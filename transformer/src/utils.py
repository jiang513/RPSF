...
class ReplayBuffer(object):
	...
	def __init__(self, obs_shape, action_shape, capacity, batch_size, aux_batch_size, crop, prefill=True):
		...
		if crop == 'vitcrop':
			...
			self.shift=augmentations.random_shift
		else:
	...
	def add(self, obs, action, reward, next_obs, done, episode):
		obses = (obs, next_obs)
	...
	def sample_svea(self, n=None):
		...
		obses = self.crop(obses)
		next_obses = self.crop(next_obses)
