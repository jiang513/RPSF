...
def parse_args():
	...
	# svea
	parser.add_argument('--svea_alpha', default=1.0, type=float)
	parser.add_argument('--svea_beta', default=1.0, type=float)
	...
	parser.add_argument('--tanh_clipping', default=10.0, type=float)
	parser.add_argument('--aux_jigsaw_lr', default=3e-4, type=float)
	parser.add_argument('--aux_jigsaw_beta', default=0.9, type=float)
	parser.add_argument('--aux_batch_size',default=512, type=int)
	parser.add_argument('--aux_update_freq', default=1, type=int)

	# eval
	parser.add_argument('--save_freq', default='30k', type=str)
	...
	assert args.train_mode in modes and args.eval_mode_color_hard in modes, f'specified mode "{args.train_mode}" or "{args.eval_mode}" is not supported'
